Ext.onReady(function () {
    ...
    if ( /wrcc.dri.edu/.test(window.location) ) {
    	    ...
    	    URL = "/wwdt/"; // include trailing slash
    }
    //URL = "http://mist.dri.edu:8000"

    //URL = "http://www.wrcc.dri.edu/monitor/WWDT/time/"
    //URL = "http://127.0.0.1:8000"
    
    var spanStore = [['1', "1-Month"],
            ['2', "2-Month"],
            ['3', "3-Month"],
            ['4', "4-Month"],
            ['5', "5-Month"],
    ...
    dataSubmit = Ext.extend(Ext.Button, {
        handler: function () {
            ...
            Ext.getCmp('tabPanel').add({
                ...
                autoScroll: true, //////Set this to active when text is rendered with plots
